...
@Component({
  selector: 'app-english-yoga',
  templateUrl: './english-yoga.component.html',
  styleUrls: ['./english-yoga.component.css']
})
export class EnglishYogaComponent implements OnInit {
		// activee="Active";
